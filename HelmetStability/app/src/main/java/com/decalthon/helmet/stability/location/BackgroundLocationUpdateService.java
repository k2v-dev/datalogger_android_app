package com.decalthon.helmet.stability.location;
...
/**
 * Create service which run in background and retrieve the updated GPS details
 */
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private final String TAG = "BgLocationUpdateService";
    ...
    private void StartForeground() {
        ...
        builder.setContentTitle("GPS track");
        builder.setContentText("GPS tracking is start");
    ...
    public void onLocationChanged(Location location) {
            // On receiving update, it pass the data to DeviceFragment
                ...
                switch (statusCode) {
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            rae.startResolutionForResult(MainActivity.shared(), REQUEST_CHECK_SETTINGS);
                        } catch (Exception sie) {
