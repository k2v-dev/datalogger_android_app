...
import com.decalthon.helmet.stability.Utilities.DrawableUtils;
...
public class MonthlyCalendarFragment extends Fragment {
    ...
    private static final String monthClicked = "param1";
    private static final String yearOfSelectedMonth = "param2";
    ...
    public MonthlyCalendarFragment()
{
    ...
    public static MonthlyCalendarFragment newInstance(String param1, String param2) {
        ...
        args.putString(monthClicked, param1);
        args.putString(yearOfSelectedMonth, param2);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(monthClicked);
            mParam2 = getArguments().getString(yearOfSelectedMonth);
        }
    }
...
//            latestDate = getMostRecentSessionDate(sortedCalendar).getTime();
        ...
        monthToBeDisplayed.set(2020,Integer.parseInt(mParam1),1);
